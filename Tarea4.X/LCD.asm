...
SEND_DATA
    ...
    bcf	    E			; Stop Enable.
    clrf    dataLCD
    call    esperaLCD		; Wait to see if LCD is done.
    return
...
esperaLCD
    ...
    btfsc   PORTD, 7, A		; Read bussy flag.
    goto    esperaLCD		; If set, keep waiting.
...
; Duda: Como leer busy flag si es una salida, no una entrada.