...
${OBJECTDIR}/Part1_2.o: Part1_2.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Part1_2.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Part1_2.lst\" -e\"${OBJECTDIR}/Part1_2.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Part1_2.o\" \"Part1_2.asm\" 
